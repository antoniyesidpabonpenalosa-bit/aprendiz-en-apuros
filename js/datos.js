...
const LOGROS=[
  ...
  {id:'maraton', ico:'♾️', es:'MARATÓN',       en:'MARATHON',
   pes:'Aguanta 10 rondas en SIN FIN',pen:'Survive 10 rounds in ENDLESS'},
...
const TXT={
 ...
 /* Salas de clase (salaui.js) */
 modo_sala:'SALA DE CLASE',sala_tit:'SALA DE CLASE',
 sala_expl:'El instructor crea una sala y la proyecta; el grupo entra con el código y todos juegan lo mismo a la vez.',
 sala_soy_prof:'INSTRUCTOR',sala_crear_expl:'Elige dificultad y minijuegos, y proyecta el código.',sala_crear:'CREAR SALA',
 ...
 sala_esperan:'{n} en la sala · esperando para empezar',sala_van:'Jugando · {a} de {n} terminaron',sala_final:'¡RESULTADO FINAL!',
 sala_vacia:'Aún no ha entrado nadie. Proyecta el código para que el grupo se una.',
 sala_esperando:'SALA DE ESPERA',sala_espera_prof:'Espera a que el instructor empiece',
 sala_fuera:'El instructor te sacó de la sala',sala_no_unido:'No estás en esta sala: entra con el código',
 sala_en_juego:'LA SALA YA EMPEZÓ',sala_te_quedan:'Te quedan {n} rondas',sala_seguir:'SEGUIR JUGANDO',sala_salir:'SALIR DE LA SALA',
 sala_empieza:'¡PREPÁRATE!',sala_siguiente:'SIGUIENTE',sala_sig:'SIGUIENTE',
 sala_terminaste:'¡TERMINASTE!',sala_tabla:'TABLA DE LA SALA',sala_puesto:'Puesto {p} de {n}',sala_volver:'VOLVER A LA SALA',
 lab_tit:'CONSOLA',lab_sub:'laboratorio · nada de esto se guarda',lab_orden:'orden',
 lab_bienvenida:'Escribe "ayuda" y pulsa ↵',lab_cerrar:'cerrar',
 lab_ensayo:'ENSAYO',lab_ensayo_ay:'partida de prueba: no da puntos ni sube al marcador',
 lab_no_sala:'La consola no se abre dentro de una sala: ahí se juega derecho',
 lab_sala_ensayo:'Estás en un ENSAYO. Abre la consola y escribe "normal" antes de entrar a una sala.',
 personaje:'PERSONAJE',pe_guardado:'CAMBIOS GUARDADOS',pe_comprado:'COMPRADO',
 pe_bloqueado:'BLOQUEADO',pe_ninguno:'SIN ACCESORIO',pe_comprar:'COMPRAR',
 pe_confirma:'¿Comprar {n} por ⛁{p}?',pe_faltan:'Te faltan ⛁{p}',
 pe_detalle:'DETALLE DEL RETRATO',pe_detalle16:'🕹 16×16',pe_detalle32:'🔍 32×32',
 ...
 sinfin_mejor:'TU MEJOR',sinfin_jugar:'▶ EMPEZAR',sinfin_ronda:'RONDA {n} SUPERADA',
 ...
 en:{dia:'DAY',start:'PRESS START',jugar:'▶ PLAY',tienda:'SHOP',logros:'AWARDS',records:'RECORDS',perso:'MY AVATAR',
  ...
  modo_sala:'CLASSROOM',sala_tit:'CLASSROOM',
  sala_expl:'The instructor creates a room and projects it; the class joins with the code and everyone plays the same games at once.',
  sala_soy_prof:'INSTRUCTOR',sala_crear_expl:'Pick a difficulty and minigames, then project the code.',sala_crear:'CREATE ROOM',
  ...
  sala_esperan:'{n} in the room · waiting to start',sala_van:'Playing · {a} of {n} finished',sala_final:'FINAL RESULTS!',
  sala_vacia:'Nobody has joined yet. Project the code so the class can join.',
  sala_esperando:'WAITING ROOM',sala_espera_prof:'Waiting for the instructor to start',
  sala_fuera:'The instructor removed you from the room',sala_no_unido:'You are not in this room: join with the code',
  sala_en_juego:'THE ROOM HAS STARTED',sala_te_quedan:'{n} rounds left',sala_seguir:'KEEP PLAYING',sala_salir:'LEAVE ROOM',
  sala_empieza:'GET READY!',sala_siguiente:'NEXT',sala_sig:'NEXT',
  sala_terminaste:'YOU FINISHED!',sala_tabla:'ROOM STANDINGS',sala_puesto:'Place {p} of {n}',sala_volver:'BACK TO THE ROOM',
  lab_tit:'CONSOLE',lab_sub:'lab · none of this is saved',lab_orden:'command',
  lab_bienvenida:'Type "help" and press ↵',lab_cerrar:'close',
  lab_ensayo:'REHEARSAL',lab_ensayo_ay:'practice run: no points, nothing published',
  lab_no_sala:'The console does not open inside a room: there you play straight',
  lab_sala_ensayo:'You are in a REHEARSAL. Open the console and type "reset" before joining a room.',
  personaje:'CHARACTER',pe_guardado:'CHANGES SAVED',pe_comprado:'OWNED',
  pe_bloqueado:'LOCKED',pe_ninguno:'NO ACCESSORY',pe_comprar:'BUY',
  pe_confirma:'Buy {n} for ⛁{p}?',pe_faltan:'You need ⛁{p} more',
  pe_detalle:'PORTRAIT DETAIL',pe_detalle16:'🕹 16×16',pe_detalle32:'🔍 32×32',
  ...
  sinfin_mejor:'YOUR BEST',sinfin_jugar:'▶ START',sinfin_ronda:'ROUND {n} CLEARED',
