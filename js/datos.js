...
const TXT={
 es:{dia:'DÍA',start:'PULSA START',jugar:'▶ JUGAR',tienda:'TIENDA',logros:'LOGROS',records:'RÉCORDS',perso:'MI AVATAR',
  ...
  tipo_quiz:'QUIZ',tipo_review:'CODE REVIEW',tipo_merge:'CONFLICTOS',tipo_sql:'SQL',tipo_regex:'REGEX',glob_loc:'💾 TUS MARCAS',glob_carga:'CONSULTANDO…',
 ...
 en:{dia:'DAY',start:'PRESS START',jugar:'▶ PLAY',tienda:'SHOP',logros:'AWARDS',records:'RECORDS',perso:'MY AVATAR',
  ...
  tipo_quiz:'QUIZ',tipo_review:'CODE REVIEW',tipo_merge:'CONFLICTS',tipo_sql:'SQL',tipo_regex:'REGEX',glob_loc:'💾 YOUR SCORES',glob_carga:'LOADING…',
